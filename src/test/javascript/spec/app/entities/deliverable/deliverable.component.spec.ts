...
import { DeliverableComponent } from 'app/entities/deliverable/deliverable.component';
...
describe('Component Tests', () => {
    describe('Deliverable Management Component', () => {
        let comp: DeliverableComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(DeliverableComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.deliverables[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
