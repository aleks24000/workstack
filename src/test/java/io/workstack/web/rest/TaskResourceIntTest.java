...
import io.workstack.domain.Task;
import io.workstack.repository.TaskRepository;
import io.workstack.repository.search.TaskSearchRepository;
import io.workstack.service.TaskService;
...
public class TaskResourceIntTest {
     ...
     *
     * @see io.workstack.repository.search.TaskSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createTask() throws Exception {
        ...
        assertThat(testTask.getSpentTime()).isEqualTo(DEFAULT_SPENT_TIME);
    ...
    public void updateTask() throws Exception {
        ...
        assertThat(testTask.getSpentTime()).isEqualTo(UPDATED_SPENT_TIME);
